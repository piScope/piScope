...
class LinePythonSTC(PythonSTC):
    def __init__(self, *args, **kargs):
        ...
        self._marker1s = []
        self._margins = [self.GetMarginWidth(0), self.GetMarginWidth(1), self.GetMarginWidth(2)]
        self._get_down = -1
        self._line_down = -1
...
#            self.Unbind(wx.EVT_CHAR)
    ...
    def onLeftDown(self, e):
        self._line_down = self.LineFromPosition(self.PositionFromPoint(e.GetPosition()))
...
#        wx.CallAfter(self.update_marker, l1, l2)
    ...
    def onCopyToShell(self, evt):
        ...
        for i, x in enumerate(line):
            ...
            app.shell.Paste()
            if i != len(line)-1: app.shell.NewLine()

class CommandHistory(wx.Panel):
    def __init__(self, parent,*args,**kargs):
        super(CommandHistory, self).__init__(parent, *args, **kargs)
        self.log = LinePythonSTC(self, -1, style=wx.TE_MULTILINE|wx.TE_READONLY) 
