...
class XUser(object):
    ...
    def get_xaxisparam(self):
        if self._ax is None:
           ...
           get_axisparam(figaxes, figaxes._xaxis, self, self.set_ax, self._container_idx)
...
class YUser(object):
    ...
    def get_yaxisparam(self):
        if self._ay is None:
           ...
           get_axisparam(figaxes, figaxes._yaxis, self, self.set_ay, self._container_idx)
...
class ZUser(object):
    ...
    def get_zaxisparam(self):
        if self._az is None:
           ...
           get_axisparam(figaxes, figaxes._zaxis, self, self.set_az, self._container_idx)
        return self._az()
...
class CUser(object):
    ...
    def get_caxisparam(self):
        if self._ac is None:
           ...
           get_axisparam(figaxes, figaxes._caxis, self, self.set_ac, self._container_idx)
        return self._ac()
    ...
    def has_cbar(self):
        figaxes = self.get_figaxes()
        if self._ac is None: False
        if figaxes is None:False
        ac = self._ac()
        return ac.has_cbar()
    def show_cbar(self):
        figaxes = self.get_figaxes()
        if self._ac is None:return      
